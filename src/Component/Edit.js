...
export default function FormEdit() {
  ...
  useEffect(() => {
    if (todoUpdate) {
      ...
      setTitleOption(todoUpdate.titleOption || '');
    }
  }, [todoUpdate]);
      ...
      try {
        if (todoUpdate) {
          await dispatch(updateTodo(todoUpdate.id, {
            name, titleOption, employeeid, email, mobile, date, address, state, city, pcode, gender, mstatus, country
          }));
        }
        navigate('/table');
      } catch (error) {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='form-group footer'>
            ...
            <div className='error'>
              ...
              />
              {errors.pcode && <p className="error">{errors.pcode}</p>}
            </div>
          </div>
          <div className='we-er'>
